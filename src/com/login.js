...
Privacy   Contact</p>
            ...
            <div className="loginbox loginsi">
                <form>
                    ...
                    <input className='logiin' placeholder='User Name'/>
                    
                
                    <input className='logiin' placeholder='Password'/>

                   <a className='loga' href="">Forgot Password?</a><button className='logbtn'>Signin</button>
